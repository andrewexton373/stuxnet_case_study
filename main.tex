...
\begin{framed}
The state-sponsors of Stuxnet must \ul{keep in its existing state the lack of corruption of facts}, being quick to \ul{detect indications of a situation resulting} from \ul{no longer current occurrences.}
\end{framed}
